...
from SWEET_TOXIC_MUSIC.utils.errors import capture_err
import httpx 
from pyrogram.types import InlineKeyboardButton, InlineKeyboardMarkup
...
async def start(_, msg):
    buttons = [
        ...
        [
          InlineKeyboardButton("𝗛𝗘𝗟𝗣", url="https://t.me/SweetToxicUpdate"),
          InlineKeyboardButton("𝗢𝗪𝗡𝗘𝗥", url="https://t.me/SWEET_TOXIC_DEVIL"),
          ],
               [
                InlineKeyboardButton("𝗟𝗜𝗩𝗘 𝗖𝗖", url="https://t.me/SweetToxicUpdate"),

],
[
              InlineKeyboardButton("𝗕𝗔𝗡 𝗔𝗟𝗟︎", url=f"https://github.com/DAXXTEAM/DAXXBANALL"),
              InlineKeyboardButton("︎𝗠𝗨𝗦𝗜𝗖", url=f"https://github.com/DAXXTEAM/SWEET_TOXIC_MUSIC"),
              ],
              [
...
async def repo(_, message):
    async with httpx.AsyncClient() as client:
        response = await client.get("https://api.github.com/repos/DAXXTEAM/SWEET_TOXIC_MUSIC/contributors")
    ...
    if response.status_code == 200:
        ...
        text = f"""[𝖱𝖤𝖯𝖮 𝖫𝖨𝖭𝖪](https://github.com/DAXXTEAM/SWEET_TOXIC_MUSIC) | [𝖦𝖱𝖮𝖴𝖯](https://t.me/HEROKUFREECC)
| 𝖢𝖮𝖭𝖳𝖱𝖨𝖡𝖴𝖳𝖮𝖱𝖲 |
----------------
{list_of_users}"""
