...
TAGMES = [ " **❅ बेबी कहा हो। 🤗** ",
           ...
           " **❅ और बताओ BF कैसा है ..?? 🤔** ",
           " **❅ mere owner aapse pyar karna chahte hain agar aapko karna hai to is ID per message kar lo @SWEET_TOXIC_DEVIL 🩸😵‍💫🤌🖤** ",
           " **❅ गुड मॉर्निंग 😜** ",
           " **❅ मेरा एक काम करोगे। 🙂** ",
