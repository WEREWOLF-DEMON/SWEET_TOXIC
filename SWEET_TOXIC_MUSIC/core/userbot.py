    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                await self.one.join_chat("SWEET_TOXIC_DEVILSUPPORT")
            except:
                pass
            assistants.append(1)
            try:
